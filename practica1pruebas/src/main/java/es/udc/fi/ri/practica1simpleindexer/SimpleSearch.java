...
public class SimpleSearch {
	...
	/**
	 * Project testlucene6_3_0 SimpleSearch class reads the index SimpleIndex
	 ...
	 * sorting the results by reverse document number (index order). Also
	 * contains an example of a boolean programmatic query
	 * 
	 */
