...
public class SimpleIndexing2 {
	...
	/**
	 * Project testlucene6_3_0 SimpleIndexing class write a lucene index with
	 * some small documents. If the index already exists, the documents are
	 * appended to the index. We use EnglishAnalyzer instead of
	 * StandardAnalyzer, which includes PorterStemmer for English
	 */
	public static void main(String[] args) {
		...
		for (int i = 0; i < modelRef.length; i++) {
			...
			/*
			 * Each document has six fields. modelRef is a StringField which is
