...
public class CACMEval {
	...
	public static double evaluateQuery(String indexInPath, List<String> queriesList, int n, int m, int queryID, String ir_model, float parameter) throws IOException {
		Directory dir = null;
	...
	public static void main(String args[]) throws IOException {
		...
		case "-queries":
			...
			evaluateQuery(indexInPath, queriesList, Integer.parseInt(n),Integer.parseInt(m), QuerySearcher.getFirstQueryID(), ir_model, Float.parseFloat(parameter));
			break;
		}
